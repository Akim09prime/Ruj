...
export const Home: React.FC = () => {
  ...
  return (
    <div className="pt-0">
      {/* Hero Section */}
      <section className="relative h-screen flex items-center overflow-hidden group">
        <div className="absolute inset-0 z-0 overflow-hidden bg-black">
          <img 
            src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&q=80&w=2400" 
            className="w-full h-full object-cover transform scale-105 transition-all duration-[2000ms]"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-3xl">
            ...
            <h1 className="font-serif text-5xl md:text-8xl leading-[1.1] mb-8 animate-slide-up opacity-0">
              {lang === 'ro' 
                ? 'Mobilier la comandă realizat cu precizie CNC.' 
                : 'Custom furniture crafted with CNC precision.'}
            </h1>
            <p className="text-lg md:text-xl font-light mb-12 max-w-xl text-white/70 leading-relaxed animate-slide-up" style={{ animationDelay: '200ms', opacity: 0 }}>
              {lang === 'ro'
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 animate-slide-up" style={{ animationDelay: '400ms', opacity: 0 }}>
